...
function ZehirTrigger(heroName, customAbilityID)
	if customAbilityID == CUSTOM_ABILITY_1 then
		if heroName == ZehirHeroName then ZehirCreaturesGeneration(); end;
	elseif customAbilityID == CUSTOM_ABILITY_2 then
		if heroName == ZehirHeroName and ZehirTouchRegion >= 0 then ZehirMoveTownWithChecking(ZehirTouchRegion); end;
	elseif customAbilityID == CUSTOM_ABILITY_3 then
		stackSplit(heroName, customAbilityID);
	elseif customAbilityID == CUSTOM_ABILITY_4 then
		RacialAbilityBoost(heroName, customAbilityID);
	end;
end;
