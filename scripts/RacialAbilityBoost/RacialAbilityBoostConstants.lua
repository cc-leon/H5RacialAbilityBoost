...
ARTIFICER_ABILITIES = {
    ...
    [3] = {SPELL_CONSUME_CORPSE, SPELL_EFFECT_POWERFULL_BLOW, SPELL_BOSS_FIREWALL, SPELL_IMBUE_ARROW, SPELL_UBER_CHAIN_LIGHTNING, },
    [4] = {SPELL_ABILITY_AVATAR_OF_DEATH, SPELL_SPIRIT_LINK, SPELL_UBER_METEOR_SHOWER, }, }
